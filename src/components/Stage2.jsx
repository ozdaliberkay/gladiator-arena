...
export const Stage2 = () => {
  ...
  const { stage2Gladiators } = useSelector((store) => store.arena);
  ...
  useEffect(() => {
    if (stage2Gladiators) {
      sets1opg([...stage2Gladiators]);
      console.log(stage2Gladiators);
    }
  }, [stage2Gladiators]);
    ...
    if (figthInfo == "Attack an enemy gladiator") {
      if (og.currenthp > 0) {
        ...
        if (picked.isRightAtk == 1) {
          console.log(picked);
          if (picked.name == "Kyracros" && og.type == "wild") {
            setgmAtk(4);
          } else if (picked.name == "Kyracros" && og.type == "wild2") {
            setgmAtk(4);
          } else {
            setgmAtk(0);
          }
  ...
  if (!stage2Gladiators || !gladiators) {
